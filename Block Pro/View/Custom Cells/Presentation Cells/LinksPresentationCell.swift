...
class LinksPresentationCell: UITableViewCell {
    ...
    override init (style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        super.init(style: .default, reuseIdentifier: "linksPresentationCell")
    ...
    private func configureLinksLabel () {
        ...
        linksLabel.configureTitleLabelConstraints()
    ...
    private func configureLinkContainer () {
        ...
        [
            ...
            linkContainer.topAnchor.constraint(equalTo: linksLabel.bottomAnchor, constant: 10),
            linkContainer.bottomAnchor.constraint(equalTo: self.contentView.bottomAnchor, constant: 0)
    ...
    private func configureLinkCollectionView () {
        ...
        linkCollectionView.register(LinksPresentationCollectionViewCell.self, forCellWithReuseIdentifier: "linksPresentationCollectionViewCell")
    }
...
extension LinksPresentationCell: UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "linksPresentationCollectionViewCell", for: indexPath) as! LinksPresentationCollectionViewCell
