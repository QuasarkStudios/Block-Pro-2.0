    ...
    @objc func handleLongPress (gesture: UILongPressGestureRecognizer) {
        ...
        if gesture.state == .began {
            ...
            if photoImageViewLocation?.contains(pressedLocation) ?? false {
                ...
                animatePhotoImage_MessageTextView(view: imageViewContainer)
            }
                ...
                animatePhotoImage_MessageTextView(view: messageBubbleView)
            }
        }
    }
    
    private func animatePhotoImage_MessageTextView (view: UIView) {
