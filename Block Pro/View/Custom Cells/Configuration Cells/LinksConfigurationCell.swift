...
class LinksConfigurationCell: UITableViewCell {
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        super.init(style: .default, reuseIdentifier: "linksConfigurationCell")
    ...
    private func configureCollectionView () {
        ...
        linkCollectionView.register(LinksConfigurationCollectionViewCell.self, forCellWithReuseIdentifier: "linksConfigurationCollectionViewCell")
    }
    ...
    private func presentEditLinkAlert (textField: UITextField) {
        ...
        else if let viewController = linksConfigurationDelegate as? ConfigureBlockViewController {
    ...
    @objc private func keyboardBeingPresented (notification: NSNotification) {
        ...
        if !keyboardPresent {
            ...
            for visibleCell in linkCollectionView.visibleCells {
                ...
                if let cell = visibleCell as? LinksConfigurationCollectionViewCell {
            ...
            if textFieldSelected {
                ...
                if let viewController = linksConfigurationDelegate as? CreateCollabViewController, let tableView = viewController.details_attachmentsTableView {
                    ...
                    //y-coord for the linkConfigurationCell in the CreateCollabViewController
                    let createLinkCellMinY = tableView.rectForRow(at: IndexPath(row: 6, section: 0)).minY
                    
                    //Distance from the top of the linkConfigurationCell to the top of the link collection view cell, i.e. 40; + the itemSize, i.e. 80; - (half the height of the linkTextField + the bottomAnchor of the linkTextField), i.e. 10.5
                    ...
                    //y-coord for the linkConfigurationCell in the ConfigureBlockViewController
                    let createLinkCellMinY = tableView.rectForRow(at: IndexPath(row: 7, section: 0)).minY
                    
                    //Distance from the top of the linkConfigurationCell to the top of the link collection view cell, i.e. 40; + the itemSize, i.e. 80; - (half the height of the linkTextField + the bottomAnchor of the linkTextField), i.e. 10.5
                    let textFieldCenter: CGFloat = 40 + 80 - 10.5
                    
                    //y-coord of the configure block table view in regards to the keyWindow
                    let tableViewMinY = viewController.view.convert(tableView.frame, to: keyWindow).minY
    ...
    @objc func attachButtonPressed () {
        ...
        linksConfigurationDelegate?.attachLinkSelected()
    }
...
extension LinksConfigurationCell: UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "linksConfigurationCollectionViewCell", for: indexPath) as! LinksConfigurationCollectionViewCell
        
        cell.linksConfigurationDelegate = linksConfigurationDelegate
...
extension LinksConfigurationCell: UITextFieldDelegate {
    
    func textFieldDidBeginEditing(_ textField: UITextField) {
        
        if let linkCollectionViewCell = linkCollectionView.visibleCells.first as? LinksConfigurationCollectionViewCell {
    ...
    func textFieldDidEndEditing(_ textField: UITextField) {
        ...
        if let linkCollectionViewCell = linkCollectionView.visibleCells.first as? LinksConfigurationCollectionViewCell {
            ...
            if linkBeingRenamed {
                ...
                linksConfigurationDelegate?.linkRenamed(linkID, textField.text!)
            ...
            //If a link was being entered/edited
                ...
                linksConfigurationDelegate?.linkEntered(linkID, textField.text!)
                ...
                if let linkIndex = links?.firstIndex(where: { $0.linkID == linkID }) {
                    ...
                    if links?[linkIndex].url?.leniantValidationOfTextEntered() ?? false {
                        ...
                        retrieveFavIcon(urlString: links?[linkIndex].url!) { [weak self] (icon) in
                            ...
                            self?.linksConfigurationDelegate?.linkIconSaved(linkID, icon)
                        }
                    }
                    ...
                    //If a url wasn't entered/a url was deleted
                        ...
                        linksConfigurationDelegate?.linkIconSaved(linkID, nil)
                    }
                }
            }
