//
//  VoiceMemoConfigurationCollectionViewCell.swift
//  Block Pro
//
...
class VoiceMemoConfigurationCollectionViewCell: UICollectionViewCell {
    ...
    weak var voiceMemosConfigurationCell: VoiceMemosConfigurationCell? {
        didSet {
            
            nameTextField.delegate = voiceMemosConfigurationCell
        }
    }
    ...
    private func beginRecordingPlayback () {
        ...
        self.voiceMemosConfigurationCell?.stopRecordingPlaybackOfVoiceMemoCell() //Stops the recording playback of other "voiceMemoCells"
        ...
        self.voiceMemosConfigurationCell?.playbackRecording(self.voiceMemo?.voiceMemoID ?? "")
    ...
    @objc private func visualizerTapped () {
        ...
        if recordingPlaying ?? false {
            ...
            if !(voiceMemosConfigurationCell?.willBeginRecording ?? false) && !(voiceMemosConfigurationCell?.recording ?? false) {
    ...
    @objc private func nameTextChanged () {
        ...
        voiceMemosConfigurationCell?.voiceMemosConfigurationDelegate?.voiceMemoNameChanged(voiceMemo?.voiceMemoID ?? "", nameTextField.text)
    }
}
