//
//  LocationsConfigurationCell.swift
//  Block Pro
//
...
class LocationsConfigurationCell: UITableViewCell {
    ...
    weak var locationsConfigurationDelegate: LocationsConfigurationProtocol?
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        super.init(style: .default, reuseIdentifier: "locationsConfigurationCell")
    ...
    @objc private func attachButtonPressed () {
        ...
        locationsConfigurationDelegate?.attachLocationSelected()
    }
...
extension LocationsConfigurationCell: MKMapViewDelegate {
