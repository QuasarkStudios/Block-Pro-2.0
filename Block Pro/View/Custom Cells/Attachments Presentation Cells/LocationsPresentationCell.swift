//
//  LocationsPresentationCell.swift
//  Block Pro
//
...
class LocationsPresentationCell: UITableViewCell {
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        super.init(style: .default, reuseIdentifier: "locationsPresentationCell")
    ...
    private func configureLocationsLabel () {
        ...
        locationsLabel.configureTitleLabelConstraints()
    ...
    private func configureMapView () {
        ...
        [
            ...
            mapViewContainer.topAnchor.constraint(equalTo: locationsLabel.bottomAnchor, constant: 10),
...
extension LocationsPresentationCell: MKMapViewDelegate {
